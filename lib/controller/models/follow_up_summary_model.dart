...
List<FollowUpSummaryModel> followUpSummaryModelFromJson(String str) =>
    List<FollowUpSummaryModel>.from(
        json.decode(str).map((x) => FollowUpSummaryModel.fromJson(x)));

String followUpSummaryModelToJson(List<FollowUpSummaryModel> data) =>
