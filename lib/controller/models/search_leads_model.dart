...
class SearchLeadModel {
  ...
  factory SearchLeadModel.fromJson(Map<String, dynamic> json) {
    ...
    return SearchLeadModel(
      ...
      branchId: parseInt(json['branch_id'] ?? json['Branch_Id']),
      ...
      consumerNo: parseString(json['Consumer_Number']),
      ...
      remark: parseString(json['remark'] ?? json['Remark']),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'Audio_Files': audioFiles.map((item) => item.toJson()).toList(),
