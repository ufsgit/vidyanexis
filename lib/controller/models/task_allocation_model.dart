...
List<TaskAllocationSummaryModel> taskAllocationSummaryModelFromJson(
        String str) =>
    List<TaskAllocationSummaryModel>.from(
        json.decode(str).map((x) => TaskAllocationSummaryModel.fromJson(x)));

String taskAllocationSummaryModelToJson(
        List<TaskAllocationSummaryModel> data) =>
...
class TaskAllocationSummaryModel {
  ...
  factory TaskAllocationSummaryModel.fromJson(Map<String, dynamic> json) =>
      TaskAllocationSummaryModel(
...
List<TaskAllocationStatusModel> taskAllocationStatusModelFromJson(String str) =>
    List<TaskAllocationStatusModel>.from(
        json.decode(str).map((x) => TaskAllocationStatusModel.fromJson(x)));

String taskAllocationStatusModelToJson(List<TaskAllocationStatusModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class TaskAllocationStatusModel {
  ...
  factory TaskAllocationStatusModel.fromJson(Map<String, dynamic> json) =>
      TaskAllocationStatusModel(
