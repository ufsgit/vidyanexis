...
DocumentChecklistModel documentChecklistModelFromJson(String str) =>
    DocumentChecklistModel.fromJson(json.decode(str));

String documentChecklistModelToJson(DocumentChecklistModel data) =>
    ...
    String? usrName,
      ...
      DocumentChecklistModel(
        documentCheckListMasterId:
            documentCheckListMasterId ?? this.documentCheckListMasterId,
        entryDate: entryDate ?? this.entryDate,
        userId: userId ?? this.userId,
        usrName: usrName ?? this.usrName,
      );

  factory DocumentChecklistModel.fromJson(Map<String, dynamic> json) =>
      DocumentChecklistModel(
