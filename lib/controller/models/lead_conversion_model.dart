...
List<List<LeadCoversionChartModel>> leadCoversionChartModelFromJson(String str) => List<List<LeadCoversionChartModel>>.from(json.decode(str).map((x) => List<LeadCoversionChartModel>.from(x.map((x) => LeadCoversionChartModel.fromJson(x)))));

String leadCoversionChartModelToJson(List<List<LeadCoversionChartModel>> data) => json.encode(List<dynamic>.from(data.map((x) => List<dynamic>.from(x.map((x) => x.toJson())))));
...
class LeadCoversionChartModel {
    ...
    factory LeadCoversionChartModel.fromJson(Map<String, dynamic> json) => LeadCoversionChartModel(
