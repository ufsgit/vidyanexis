...
CheckListItemModel checkListItemModelFromJson(String str) =>
    CheckListItemModel.fromJson(json.decode(str));

String checkListItemModelToJson(CheckListItemModel data) =>
