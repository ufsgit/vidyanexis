...
import 'package:techtify/controller/models/follow_up_report_model.dart';
import 'package:techtify/controller/models/quotation_report_model.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null) {
          ...
          _quotationReports = (data as List<dynamic>)
