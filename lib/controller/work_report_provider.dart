...
import 'package:vidyanexis/controller/models/work_report_model.dart';
  ...
  getSearchTaskReport(String byUserId, BuildContext context) async {
    try {
      ...
      final response = await HttpRequest.httpGetRequest(
          endPoint:
              '${HttpUrls.searchWorkReport}?Fromdate=$_fromDateS&Todate=$_toDateS&SearchbyName=$_Search&By_User=$byUserId&Is_Date_Check=$isDate&Status_Id=$_Status');
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null) {
          ...
          _taskReport = (data as List<dynamic>)
              .map((item) => WorkReportModel.fromJson(item))
              .toList();
