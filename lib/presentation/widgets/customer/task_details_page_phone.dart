                        ...
                        child: IntrinsicHeight(
                          child: Row(
                            ...
                            children: [
                              Container(
                                width: 5,
                                color: customerDetailsProvider.taskDetails[0].taskStatusName == "Completed"
                                    ? Colors.green
                                    : customerDetailsProvider.taskDetails[0].taskStatusName == "In Progress"
                                        ? Colors.orange
                                        : Colors.red,
                              ),
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Image.asset(
                                              customerDetailsProvider.taskDetails[0].taskTypeId == 1
                                                  ...
                                                  : customerDetailsProvider.taskDetails[0].taskTypeId == 2
                                                      ? 'assets/images/icon_installation.png'
                                                      : customerDetailsProvider.taskDetails[0].taskTypeId == 3
                                      ...
                                      if (dropDownProvider.getEnquiryForNameById(
                                              customerDetailsProvider.taskDetails[0].enquiryForId ?? 0,
                                              customerDetailsProvider.taskDetails[0].enquiryForName)
                                          .isNotEmpty) ...[
                                        Text(
                                          dropDownProvider.getEnquiryForNameById(
                                              customerDetailsProvider.taskDetails[0].enquiryForId ?? 0,
                                              customerDetailsProvider.taskDetails[0].enquiryForName),
                                          style: GoogleFonts.plusJakartaSans(
                                            fontSize: 13,
                        ...
                        child: Container(
                          ...
                          child: TileWidget(
                            ...
                            leading: Container(
                              ...
                              height: 32,
                              decoration: BoxDecoration(
                                color: getAvatarColor(taskUser.userDetailsName).withOpacity(0.1),
