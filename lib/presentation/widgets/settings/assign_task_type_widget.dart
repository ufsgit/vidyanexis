...
class AssignTaskTypeWidget extends StatefulWidget {
  const AssignTaskTypeWidget({super.key, required this.userModel});
  final GetUserModel userModel;

  @override
  _AssignTaskTypeWidgetState createState() => _AssignTaskTypeWidgetState();
}

class _AssignTaskTypeWidgetState extends State<AssignTaskTypeWidget> {
  bool _isLoading = true;
  bool _selectAll = false;
  List<UserTaskTypeModel> _items = [];
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final loadedList = await settingsProvider.getUserTaskType(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        'Manage Task Type of ${widget.userModel.userDetailsName}',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: CustomElevatedButton(
                        isLoading: settingsProvider.isSavingUserTaskType,
                        onPressed: () async {
                          await settingsProvider.saveUserTaskTypeList(
                            context: context,
