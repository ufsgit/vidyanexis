...
class _AddCheckListState extends State<AddCheckList> {
  String? validateInputs(
    ...
    if (settingsProvider.checkListController.text.trim().isEmpty) {
      return 'Please enter Checklist Type';
    }
  ...
  void initState() {
    ...
    if (widget.isEdit) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        settingsProvider.checkListController.text = widget.status;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Text(
            widget.isEdit ? 'Edit Checklist Type' : 'Add Checklist Type',
                ...
                children: [
                  Expanded(
                    child: CustomTextField(
                      readOnly: false,
                      height: 54,
                      controller: settingsProvider.checkListController,
                      hintText: 'Checklist Type name*',
                      labelText: '',
                    ),
                  ),
                ],
      ...
      actions: [
        ...
        CustomElevatedButton(
          ...
          onPressed: () async {
            ...
            settingsProvider.addCheckListType(
              context: context,
              forId: widget.editId,
