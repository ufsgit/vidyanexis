...
class AssignEnquiryForWidget extends StatefulWidget {
  const AssignEnquiryForWidget({super.key, required this.userModel});
  final GetUserModel userModel;

  @override
  _AssignEnquiryForWidgetState createState() => _AssignEnquiryForWidgetState();
}

class _AssignEnquiryForWidgetState extends State<AssignEnquiryForWidget> {
  bool _isLoading = true;
  bool _selectAll = false;
  List<UserEnquiryForModel> _items = [];
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final loadedList = await settingsProvider.getUserEnquiryFor(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Expanded(child: Text('Enquiry For Option')),
                          SizedBox(
                            width: 48,
                            child: Center(
                              child: Checkbox(
