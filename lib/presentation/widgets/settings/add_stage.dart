...
class _AddStageState extends State<AddStage> {
  String? validateInputs(
    ...
    if (settingsProvider.stageController.text.trim().isEmpty) {
  ...
  void initState() {
    ...
    if (widget.isEdit) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        settingsProvider.stageController.text = widget.status;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Text(
            widget.isEdit ? 'Edit Stage' : 'Add Stage',
                ...
                children: [
                  Expanded(
                    child: CustomTextField(
                      readOnly: false,
                      height: 54,
                      controller: settingsProvider.stageController,
                      hintText: 'Stage Name*',
                      labelText: '',
                    ),
                  ),
      ...
      actions: [
        ...
        CustomElevatedButton(
          ...
          onPressed: () async {
            ...
            settingsProvider.addStage(
              context: context,
              stageId: widget.editId,
