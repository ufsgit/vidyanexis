                                  ...
                                  suffixIcon: Padding(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        print(query);
                                        if (expenseProvider
                                            .searchSales.isNotEmpty) {
                                          searchController.clear();
                                          expenseProvider
                                              .setSearchCriteriaSales(
                                            '',
                                            expenseProvider.fromDateS,
                                            expenseProvider.toDateS,
                                            expenseProvider.status,
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(20),
                              border: Border.all(
                                  color: expenseProvider.fromDateSales !=
                                              null ||
                                  ...
                                  child: Center(
                                    child: SingleChildScrollView(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          if (expenseProvider.fromDateSales ==
                                                  null &&
                                              expenseProvider.toDateSales ==
                                                  null)
                                            const Text('Date: All',
                    ...
                    Wrap(
                      ...
                      children: List<Widget>.generate(dateButtonTitles.length,
                        ...
                        return ActionChip(
                          ...
                          label: Text(title),
                          backgroundColor:
                              leadProvider.selectedDateFilterIndexSales == index
                                  ? AppColors.primaryBlue
                                  : Colors.white,
                          labelStyle: TextStyle(
                            color: leadProvider.selectedDateFilterIndexSales ==
                                    index
                                ? Colors.white
                                : Colors.black,
                          ),
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            readOnly: true,
                            onTap: () =>
                                leadProvider.selectDateSales(context, true),
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(15),
                              ),
                              hintText: leadProvider.fromDateSales != null
                                  ? '${leadProvider.fromDateSales!.toLocal()}'
                                      .split(' ')[0]
                                  : 'From',
                        ...
                        Expanded(
                          child: TextField(
                            readOnly: true,
                            onTap: () =>
                                leadProvider.selectDateSales(context, false),
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(15),
                              ),
                              hintText: leadProvider.toDateSales != null
                                  ? '${leadProvider.toDateSales!.toLocal()}'
                                      .split(' ')[0]
                                  : 'To',
                              suffixIcon: const Icon(Icons.calendar_month),
                            ),
