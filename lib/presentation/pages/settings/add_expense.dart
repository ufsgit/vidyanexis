...
class _AddExpenseTypeState extends State<AddExpenseType> {
  String? validateInputs(
    ...
    if (settingsProvider.expenseTypeController.text.trim().isEmpty) {
  ...
  void initState() {
    ...
    if (widget.isEdit) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        settingsProvider.expenseTypeController.text = widget.status;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Text(
            widget.isEdit ? 'Edit Expense Type' : 'Add Expense Type',
          ...
          IconButton(
            onPressed: () {
              settingsProvider.expenseTypeController.clear();
              Navigator.pop(context);
            },
                ...
                children: [
                  Expanded(
                    child: CustomTextField(
                      readOnly: false,
                      height: 54,
                      controller: settingsProvider.expenseTypeController,
      ...
      actions: [
        ...
        CustomElevatedButton(
          ...
          onPressed: () async {
            ...
            settingsProvider.addExpenseType(
              context: context,
              expenseId: widget.editId,
              expenseName: settingsProvider.expenseTypeController.text,
            );
          },
