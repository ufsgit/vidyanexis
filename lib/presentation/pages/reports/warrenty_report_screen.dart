...
class WarrentyReportScreen extends StatefulWidget {
  ...
  @override
  State<WarrentyReportScreen> createState() => _WarrentyReportScreen();
}
                              ...
                              Expanded(
                                child: reportsProvider.amcReport.isEmpty
                                    ? const CommonEmptyState(
                                        message: 'No warranty reports found')
                                    : ListView.builder(
                                        shrinkWrap:
                                            true, // To avoid scrolling issues when inside a parent widget
                                        physics:
                                            const AlwaysScrollableScrollPhysics(),
                                        itemCount: reportsProvider.amcReport
