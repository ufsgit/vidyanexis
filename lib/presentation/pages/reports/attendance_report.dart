                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: ReportListItem(
                          ...
                          description: 'Check-In: ${task.checkInTimeOnly} • Check-Out: ${task.checkOutTimeOnly.isEmpty ? "-" : task.checkOutTimeOnly}',
                          statusColor: AppColors.primaryBlue,
                          bottomLeftIcon: Icons.location_on_outlined,
                          bottomLeftText: task.location.isEmpty ? 'No Location' : task.location,
