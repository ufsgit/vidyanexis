...
class FollowupReports extends StatefulWidget {
  ...
  const FollowupReports({super.key, this.fromDashBoard = false});

  @override
  State<FollowupReports> createState() => _FollowupReports();
}

class _FollowupReports extends State<FollowupReports> {
  ...
  Widget build(BuildContext context) {
    ...
    final reportsProvider = Provider.of<FollowupReportsProvider>(context);
    return Scaffold(
      key: _scaffoldKey,
                        ...
                        CustomElevatedButton(
                          onPressed: () {
                            exportToExcel(
                              ...
                              data: reportsProvider.pendingFolloWuP.map((task) {
                                return {
                                  'Customer Name': task.customerName,
                                  'Email': task.email,
                                  'Assigned To': task.toUserName,
                                  'Description': task.remark,
                                  'Date': task.nextFollowUpDate!.isNotEmpty
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ListView.builder(
                                  ...
                                  itemCount: reportsProvider.pendingFolloWuP
                                      .length, // Number of tasks
                                  itemBuilder: (context, index) {
                                    var task =
                                        reportsProvider.pendingFolloWuP[index];
  ...
  void onClickTopButton(BuildContext context) {
    showDialog(
      ...
      builder: (contextx) => Consumer<FollowupReportsProvider>(
