...
class EnquiryForSummaryReportScreen extends StatefulWidget {
  ...
  @override
  State<EnquiryForSummaryReportScreen> createState() =>
      _EnquiryForSummaryReportScreenState();
}

class _EnquiryForSummaryReportScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final reportsProvider =
          Provider.of<EnquiryForSummaryProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    final reportsProvider = Provider.of<EnquiryForSummaryProvider>(context);
  ...
  Widget _buildFilterPanel(
      BuildContext context, EnquiryForSummaryProvider reportsProvider) {
  ...
  Widget _buildReportTable(EnquiryForSummaryProvider provider) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(4),
  ...
  void onClickTopButton(BuildContext context) {
    showDialog(
      ...
      builder: (contextx) => Consumer<EnquiryForSummaryProvider>(
