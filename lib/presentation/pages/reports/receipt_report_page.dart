...
class _ReceiptReportPageState extends State<ReceiptReportPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<ReceiptReportProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ReceiptReportProvider>(context);
  ...
  Widget _buildWebBody(ReceiptReportProvider provider) {
  ...
  Widget _buildWebFilter(ReceiptReportProvider provider) {
    return Container(
  ...
  Widget _buildMobileBody(ReceiptReportProvider provider) {
    if (provider.isLoading) {
      return const Center(child: CircularProgressIndicator());
    }
  ...
  void _exportData(ReceiptReportProvider provider) {
    exportToExcel(
      ...
      data: provider.receiptReportList.map((item) {
        return {
          'Entry Date': item.entryDate,
          'Receipt No': item.receiptNo,
          'Customer Name': item.customerName,
          'Description': item.description,
          'Collected By': item.byUserName,
  ...
  void onClickTopButton(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => Consumer<ReceiptReportProvider>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        onPressed: () async {
                          await provider.getReceiptReport(context);
