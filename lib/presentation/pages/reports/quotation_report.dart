...
class QuotationReport extends StatefulWidget {
  ...
  const QuotationReport({super.key, this.fromDashBoard = false});

  @override
  State<QuotationReport> createState() => _QuotationReport();
}

class _QuotationReport extends State<QuotationReport> {
  ...
  Widget build(BuildContext context) {
    ...
    final reportsProvider = Provider.of<QuotationReportProvider>(context);
    return Scaffold(
      key: _scaffoldKey,
                        ...
                        CustomElevatedButton(
                          onPressed: () {
                            exportToExcel(
                              ...
                              data:
                                  reportsProvider.quotationReports.map((task) {
                                return {
                                ...
                                CustomElevatedButton(
                                  onPressed: () {
                                    exportToExcel(
                                      ...
                                      data: reportsProvider.quotationReports
                                          .map((task) {
                                        return {
                                          'Customer Name': task.customerName,
                                          'Email': task.customerName,
                                          'Product Name': task.productName,
                                          'Total': task.netTotal,
                                          'Date': task.entryDate!.isNotEmpty
  ...
  void onClickTopButton(BuildContext context) {
    showDialog(
      ...
      builder: (contextx) => Consumer<QuotationReportProvider>(
