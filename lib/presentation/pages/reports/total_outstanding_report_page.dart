...
class TotalOutstandingReportPage extends StatefulWidget {
  ...
  @override
  State<TotalOutstandingReportPage> createState() =>
      _TotalOutstandingReportPageState();
}

class _TotalOutstandingReportPageState
    extends State<TotalOutstandingReportPage> {
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              TableWidget(
                  data:
                      Text('₹ ${item.totalScheduleAmount.toStringAsFixed(2)}'),
                  width: 180),
              TableWidget(
                  data: Text('₹ ${item.totalPaidAmount.toStringAsFixed(2)}'),
                  width: 180),
              TableWidget(
                  data: Text(
